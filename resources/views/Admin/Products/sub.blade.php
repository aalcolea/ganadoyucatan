...
<div class="modal fade" id="agregar" tabindex="-1" aria-labelledby="agregar" aria-hidden="true">
  <div class="modal-dialog modal-xl">
    <div class="modal-content">
      <div style="background: #c31b36; border-color:#d79e46;" class="modal-header headerRegister">
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary" style="background: #d79e46; border-color: #d79e46;">Subir</button>
      </div>
    </div>
  </div>
</div>        
